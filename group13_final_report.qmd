...
## Plot1:
This is the main relationship we really looked at. Fare V Distance Traveled
...
## Plot9:
Plot9 is a bar chart, illustrating the distribution of rides based on the number of passengers, offering insights into common group sizes for travel. Understanding passenger patterns aids in the development of targeted marketing strategies, optimizing user experience, and shaping business policies. Lastly, it offers a data-driven approach to enhance overall service efficiency, resource allocation, and user satisfaction within the transportation industry.

## Plot10:
Displayed in plot10 is the relationship between tip amounts and total amounts from the dataset. The x-axis represents the tip amounts, and the y-axis represents the total amounts. We can observe a positive correlation corroborating an intuitive relationship that is represented between the total amount of the fare and the tip given. It shows how our data can also be affected
...
# Plot 8 Analysis on plots 5, 6 and 7
...
# Plot 10 Relationship Between Tip and Total Amount
...
# Plot 11 Histogram of Trip Time
