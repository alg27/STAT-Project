...
author: "Ryan Gana, Alicia Garza, Alan Yang, Kyle Zeng"
date: '4/18/2024'
format:
  revealjs: 
...
output$plot2 <- renderPlot({ggplot(df, aes(x = trip_time, y = fare_amount)) +
...
```{r, results = 'hide'}
#| context: server 
# Assuming 'df' has the columns 'trip_distance' and 'fare_amount'
x <- df$trip_distance
y <- df$fare_amount
